...
from istore.apps.customer import views
from istore.apps.customer.notifications import views as notification_views
from istore.apps.customer.alerts import views as alert_views
