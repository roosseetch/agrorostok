...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('promotions_pagepromotion', (
            ...
            ('page_url', self.gf('istore.models.fields.ExtendedURLField')(max_length=128, db_index=True)),
        ))
        ...
        db.create_table('promotions_image', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('link_url', self.gf('istore.models.fields.ExtendedURLField')(max_length=200, null=True, blank=True)),
