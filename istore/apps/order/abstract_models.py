...
from istore.apps.order.exceptions import (InvalidOrderStatus, InvalidLineStatus,
...
class AbstractOrder(models.Model):
    ...
    pipeline = getattr(settings,  'ISTORE_ORDER_STATUS_PIPELINE', {})
    cascade = getattr(settings,  'ISTORE_ORDER_STATUS_CASCADE', {})
...
class AbstractLine(models.Model):
    ...
    pipeline = getattr(settings,  'ISTORE_LINE_STATUS_PIPELINE', {})
