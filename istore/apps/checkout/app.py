...
from istore.apps.checkout.views import IndexView, ShippingAddressView, UserAddressDeleteView, UserAddressCreateView, \
...
class CheckoutApplication(Application):
    ...
    def get_url_decorator(self, pattern):
        if not settings.ISTORE_ALLOW_ANON_CHECKOUT:
