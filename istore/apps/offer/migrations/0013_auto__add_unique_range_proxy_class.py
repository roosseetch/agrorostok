...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Range', fields ['proxy_class']
        db.create_unique('offer_range', ['proxy_class'])


    def backwards(self, orm):
        # Removing unique constraint on 'Range', fields ['proxy_class']
        db.delete_unique('offer_range', ['proxy_class'])
