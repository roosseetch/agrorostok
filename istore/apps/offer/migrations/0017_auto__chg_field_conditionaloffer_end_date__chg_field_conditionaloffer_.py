...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConditionalOffer.end_date'
        db.alter_column('offer_conditionaloffer', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ConditionalOffer.start_date'
        db.alter_column('offer_conditionaloffer', 'start_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ConditionalOffer.end_date'
        db.alter_column('offer_conditionaloffer', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ConditionalOffer.start_date'
        db.alter_column('offer_conditionaloffer', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))
