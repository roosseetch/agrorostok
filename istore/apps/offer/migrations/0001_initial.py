...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('offer_conditionaloffer', (
            ...
            ('redirect_url', self.gf('istore.models.fields.ExtendedURLField')(max_length=200, blank=True)),
        ))
        ...
        db.create_table('offer_condition', (
            ...
            ('value', self.gf('istore.models.fields.PositiveDecimalField')(max_digits=12, decimal_places=2)),
        ))
        ...
        db.create_table('offer_benefit', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('value', self.gf('istore.models.fields.PositiveDecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
    ...
    models = {
        ...
        'offer.condition': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'value': ('istore.models.fields.PositiveDecimalField', [], {'max_digits': '12', 'decimal_places': '2'})
        },
