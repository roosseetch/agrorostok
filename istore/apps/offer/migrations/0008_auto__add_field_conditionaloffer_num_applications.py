...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConditionalOffer.num_applications'
        db.add_column('offer_conditionaloffer', 'num_applications',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConditionalOffer.num_applications'
        db.delete_column('offer_conditionaloffer', 'num_applications')
