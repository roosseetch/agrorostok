...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Condition.range'
        db.alter_column('offer_condition', 'range_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offer.Range'], null=True))

        # Changing field 'Condition.type'
        db.alter_column('offer_condition', 'type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'Condition.value'
        db.alter_column('offer_condition', 'value', self.gf('istore.models.fields.PositiveDecimalField')(null=True, max_digits=12, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'Condition.proxy_class'
        db.delete_column('offer_condition', 'proxy_class')


        # User chose to not deal with backwards NULL issues for 'Condition.range'
        raise RuntimeError("Cannot reverse this migration. 'Condition.range' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Condition.type'
        raise RuntimeError("Cannot reverse this migration. 'Condition.type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Condition.value'
        raise RuntimeError("Cannot reverse this migration. 'Condition.value' and its values cannot be restored.")
    ...
    models = {
        ...
        'offer.benefit': {
            ...
            'value': ('istore.models.fields.PositiveDecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'})
        },
        'offer.condition': {
        ...
        'offer.conditionaloffer': {
            ...
            'redirect_url': ('istore.models.fields.ExtendedURLField', [], {'max_length': '200', 'blank': 'True'}),
