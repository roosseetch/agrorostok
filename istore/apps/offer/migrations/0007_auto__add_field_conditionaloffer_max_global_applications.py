...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('offer_conditionaloffer', 'max_global_applications',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConditionalOffer.max_global_applications'
        db.delete_column('offer_conditionaloffer', 'max_global_applications')
