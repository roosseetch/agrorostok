...
from istore.core.utils import slugify
from istore.apps.offer.managers import ActiveOfferManager
from istore.templatetags.currency_filters import currency
from istore.models.fields import PositiveDecimalField, ExtendedURLField
...
class Benefit(models.Model):
    ...
    def round(self, amount):
        ...
        """
        if hasattr(settings, 'ISTORE_OFFER_ROUNDING_FUNCTION'):
            return settings.ISTORE_OFFER_ROUNDING_FUNCTION(amount)
...
class Range(models.Model):
    ...
    def contains_product(self, product):
        ...
        if settings.ISTORE_OFFER_BLACKLIST_PRODUCT and \
            settings.ISTORE_OFFER_BLACKLIST_PRODUCT(product):
            return False
