...
from istore.apps.basket.managers import OpenBasketManager, SavedBasketManager
from istore.apps.offer import results
...
class AbstractBasket(models.Model):
    ...
    def is_quantity_allowed(self, qty):
        basket_threshold = settings.ISTORE_MAX_BASKET_QUANTITY_THRESHOLD
        if basket_threshold:
