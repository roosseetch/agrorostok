...
from istore.apps.dashboard.reports.csv_utils import CsvUnicodeReader
from istore.apps.catalogue import models, categories
# from istore.apps.partner import models as partner_models
...
class Importer(object):
    ...
    def handle(self, product_class_name, filepath):
        ...
        for row in CsvUnicodeReader(open(filepath, 'rb')):
            if row[1] == 'UPC':
