...
from istore.core import validators
from istore.forms import fields
...
try:
    ...
    add_introspection_rules([], ["^istore\.models\.fields\.ExtendedURLField$"])
    add_introspection_rules([], [
        "^istore\.models\.fields\.PositiveDecimalField$"])
