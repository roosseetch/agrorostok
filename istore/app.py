...
from istore.apps.catalogue.app import application as catalogue_app
from istore.apps.customer.app import application as customer_app
from istore.apps.basket.app import application as basket_app
from istore.apps.checkout.app import application as checkout_app
from istore.apps.promotions.app import application as promotions_app
# from istore.apps.search.app import application as search_app
from istore.apps.offer.app import application as offer_app
from istore.apps.dashboard.app import application as dashboard_app

from istore.apps.customer import forms
from istore.views.decorators import login_forbidden
